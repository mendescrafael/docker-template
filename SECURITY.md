...
Envie o relato de forma privada pelo recurso **Report a vulnerability** da aba **Security** do repositório [mendescrafael/docker-template](https://github.com/mendescrafael/docker-template/security). Inclua, quando possível:
